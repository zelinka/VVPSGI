...
VIDs = open(".\\vectors\\cckres_VIDs.vec", encoding="utf8")
OTHRs =  open(".\\vectors\\cckres_OTHRs.vec", encoding="utf8")

singles_vec = open(".\\vectors\\cckres_singles_1.vec", encoding="utf8")

group_vec = open(".\\vectors\\cckres_grouped_VIDs.vec", encoding="utf8")
